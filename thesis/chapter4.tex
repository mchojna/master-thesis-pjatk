...
Tabela~\ref{tab:stos-technologiczny} pokazuje komponenty stosu wraz z~wersjami
i~rolami w~systemie.
...
ewaluacyjne. Tabela~\ref{tab:artefakty-systemu} przedstawia wszystkie klasy
...
Tabela~\ref{tab:prompty-systemu} podsumowuje wszystkie grupy promptów z~ich
zastosowaniem.
...
Tabela~\ref{tab:narzedzia-agentowe} przedstawia wszystkie narzędzia.
...
Tabela~\ref{tab:artefakty-ewaluacji} przedstawia artefakty wyjściowe fazy
ewaluacji.
