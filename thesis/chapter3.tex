...
Alternatywne metody badawcze przedstawiono
...
Tabela~\ref{tab:prownanie-architektur-agentowych} porównuje oba typy architektur
...
Zestawienie warunków kontrolowanych przedstawia
tabela~\ref{tab:zestawienie-warunkow-kontrolowanych}.
...
towarzystw ubezpieczeniowych: STU ERGO Hestia S.A., Powszechnego Zakładu
...
lub typu produktu. Szczegółowy rozkład pytań przedstawia
tabela~\ref{tab:zestawienie-rozkladu-pytan}.
