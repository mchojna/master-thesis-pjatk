...
wieloagentowy może działać według ściśle deterministycznego schematu.
...
autonomii w~podejmowaniu decyzji~\cite{wang2024survey, xi2025rise}. Wyróżnia
...
wzorca~\cite{papineni2002bleu, lin2004rouge, zhang2019bertscore} i~okazują się
...
IRCoT, które przeplata kroki rozumowania z~kolejnymi wyszukiwaniami -- każdy
krok wnioskowania może uruchomić nowe zapytanie do bazy
wektorowej~\cite{trivedi2023interleaving}.
